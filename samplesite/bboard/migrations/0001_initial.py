# Generated by Django 2.2 on 2021-07-11 14:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('kind', models.CharField(choices=[(None, 'Выберите разряд публикуемого объявления'), ('b', 'Куплю'), ('s', 'Продам'), ('c', 'Обменяю')], max_length=1)),
